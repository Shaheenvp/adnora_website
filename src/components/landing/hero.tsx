      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="flex flex-col items-center space-y-8">
          <div className="space-y-6 max-w-4xl animate-fade-in-up">
            <h1 className="text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-white via-neutral-300 to-primary/80 sm:text-6xl md:text-7xl bg-[200%_auto] animate-gradient-pan">
